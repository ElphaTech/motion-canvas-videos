...
export default makeScene2D(function* (view) {
  ...
  view.add(
    <>
      <Text fontFamily={'JetBrains Mono'} fontSize={300} fill={"#c92c31"} text={'Subscribe'} ref={subs} x={1920}/>
  ...
  yield* waitFor(4)
  subs().text('Bloopers')
  subs().position.x(1920)
  
  yield* waitUntil('Bloopers')
  yield all(main().position(4000,3),subs().position.x(0,3))
