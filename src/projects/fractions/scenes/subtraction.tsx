    ...
    view.add(
        <Node ref={screenNode} x={1920}>
            <Node ref={question}>
                ...
                <Text text={'1'} {...textStyle} y={-130} x={260} ref={tRightNum}/>
            ...
            <Node ref={working} scale={0.3} y={-400} opacity={0}>
                ...
                <Text text={'1'} {...textStyle} y={-130} x={260} ref={wTopRightN}/>
                ...
                <Text text={'5'} {...textStyle} opacity={0} y={-130} x={340} ref={wTopRightA}/>
            ...
            <Node ref={answer} x={255} opacity={0}>
                ...
                <Node x={425}>
                    <Text text={'3'} {...textStyle} y={-130} ref={tAnsNum} opacity={0}/>
